...
void loop() {
  ...
  HiddenCombined[0] = (input_el[0] * input_neuron[0][0]) +  //0.23 | -0.10
                      (input_el[1] * input_neuron[1][0]) +  //0.11 |  0.13
